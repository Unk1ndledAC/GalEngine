...
# 启动后，菜单 → 文件 → 打开项目 → 选择 demo_project 目录
```

### 3. 编辑和预览

- 在左侧资源管理器中点击 `.json` 或 `.md` 文件编辑场景脚本
- 点击右上角的 **预览** 按钮实时查看游戏效果
- 使用 **调试** 面板查看运行日志
...
| `chapter1.md` | Markdown (@cmd) | 第一章，展示 Markdown 格式编写剧情 |
...
- 在编辑器中体验 AI 场景生成功能：打开 AI 助手面板，用自然语言描述场景
- 基于本项目修改，创建你自己的视觉小说！

---

*GalEngine 开发团队 | 示例项目版本 v0.2.0*
